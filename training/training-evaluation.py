...
model_weights_path =  'depth_anything_v2_vits.pth' 
model_configs = {
...
def eval_only():
    ...
    model = DepthAnythingV2(**{**model_configs[model_encoder], 'max_depth': max_depth})
    model.load_state_dict(torch.load('depth_anything_v2_metric_hypersim_vits.pth', map_location=device))
    ...
    with open('./nyu_eval_results/base_metrics.json', 'w') as f:
